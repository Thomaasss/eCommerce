...
<html lang="fr">
    <head>
        ...
        <title>Multi-terrain - Nike</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="3-child-n.php">Multi-terrain</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Multi-terrain' ";
                $stmt = $pdo->query($sql);
