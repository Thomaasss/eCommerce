...
<html lang="fr">
    <head>
        ...
        <title>Terrain stabilisé - Adidas</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="4-child-a.php">Terrain stabilisé</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Adidas' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Terrain stabilisé' ";
                $stmt = $pdo->query($sql);
