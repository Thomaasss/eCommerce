...
<html lang="fr">
    <head>
        ...
        <title>Terrain gras - Adidas</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="3-child-a.php">Terrain gras</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Adidas' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Terrain gras' ";
                $stmt = $pdo->query($sql);
