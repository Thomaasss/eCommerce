...
<html lang="fr">
    <head>
        ...
        <title>Terrain souple - Adidas</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="2-child-a.php">Terrain souple</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Adidas' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Terrain souple' ";
                $stmt = $pdo->query($sql);
