...
<html lang="fr">
    ...
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="4-m-w-a.php">Terrain gras</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Homme & Femme' AND typeOfShoes = 'Terrain gras' ";
                $stmt = $pdo->query($sql);
