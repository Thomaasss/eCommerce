...
<html lang="fr">
    ...
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="3-m-w-a.php">Terrain sec</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Homme & Femme' AND typeOfShoes = 'Terrain sec' ";
                $stmt = $pdo->query($sql);
