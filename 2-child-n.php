...
<html lang="fr">
    ...
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="nike-child.php">Nike - Enfant</a>
            /
            <a href="2-child-n.php">Surface synthétique</a>
            <br>
            <br>
            <h2>CHAUSSURES DE FOOTBALL POUR ENFANT - NIKE</h2>
            <br>
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Surface synthétique' ";
                $stmt = $pdo->query($sql);
