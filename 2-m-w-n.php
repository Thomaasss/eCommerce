...
<html lang="fr">
    <head>
        ...
        <title>Surface synthétique - Nike</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="nike-m-w.php">Nike - Homme & Femme</a>
            /
            <a href="2-m-w-a.php">Surface synthétique</a>
            <br>
            <br>
            <h2>CHAUSSURES DE FOOTBALL POUR HOMME & FEMME - NIKE</h2>
            <br>
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Homme & Femme' AND typeOfShoes = 'Surface synthétique' ";
                $stmt = $pdo->query($sql);
