...
<html lang="fr">
    <head>
        ...
        <title>Multi-terrain - Adidas</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="adidas-child.php">Adidas - Enfant</a>
            /
            <a href="1-child-a.php">Multi-terrain</a>
            <br>
            <br>
            <h2>CHAUSSURES DE FOOTBALL POUR ENFANT - ADIDAS</h2>
            <br>
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Adidas' AND shoesCategory = 'Enfant' AND typeOfShoes = 'Multi-terrain' ";
                $stmt = $pdo->query($sql);
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<div class='container-product $availabilityClass'>";
