...
<html lang="fr">
    <head>
        ...
        <title>Terrain synthétique - Nike</title>
    </head>
    <body class="background-color">
        ...
        <div class="container-item">
            ...
            /
            <a href="1-m-w-a.php">Terrain synthétique</a>
            <br>
            <br>
            ...
            <div class="container-flex">
                <?php
                $sql = "SELECT * FROM product WHERE brand ='Nike' AND shoesCategory = 'Homme & Femme' AND typeOfShoes = 'Terrain synthétique' ";
                $stmt = $pdo->query($sql);
